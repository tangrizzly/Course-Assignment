...
set rc [catch {
  ...
  set_property ip_repo_paths {{d:/digital logic/lifegame/lifegame.cache/ip}} [current_project]
  set_property ip_output_repo {{d:/digital logic/lifegame/lifegame.cache/ip}} [current_project]
  add_files -quiet {{D:/digital logic/lifegame/lifegame.runs/synth_1/top.dcp}}
