...
create_clock -period 8.000 -name clk_pin -waveform {0.000 4.000} -add [get_ports clk]
set_input_delay -clock [get_clocks -filter { NAME =~  "*" }] -add_delay 0.000 [get_ports rst]
set_input_delay -clock [get_clocks -filter { NAME =~  "*" }] -min -add_delay -0.500 [get_ports rst]
set_output_delay -clock [get_clocks -filter { NAME =~  "*" }] -add_delay 0.000 [get_ports -filter { NAME =~  "*" && DIRECTION == "OUT" }]
top_xdc.xdc
set_property PACKAGE_PIN K3 [get_ports {led[0]}]
set_property PACKAGE_PIN M1 [get_ports {led[1]}]
set_property PACKAGE_PIN L1 [get_ports {led[2]}]
